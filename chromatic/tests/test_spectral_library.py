...
def test_spectral_library_R(cmap=one2another("indigo", "tomato"), N=5):
        ...
        5, 1, figsize=(8, 8), dpi=300, sharex=True, sharey=True, constrained_layout=True
    )
    for R, a in zip([10, 100, 1000, 10000, 100000], ax):
        plt.sca(a)
...
def test_spectral_library_wavelengths(cmap=one2another("indigo", "tomato"), N=5):
    ...
    for how_many, a in zip([10, 100, 1000, 10000, 100000], ax):
        plt.sca(a)
